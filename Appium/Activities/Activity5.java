...
public class Activity5 {
  ...
  public void smsTest() {
      ...
      driver.findElement(MobileBy.AndroidUIAutomator(contactBoxLocator)).sendKeys("7899886877");
      ((AndroidDriver<MobileElement>) driver).pressKey(new io.appium.java_client.android.nativekey.KeyEvent(AndroidKey.ENTER));
